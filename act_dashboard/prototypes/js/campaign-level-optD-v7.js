/* ============================================================================
   ACT PROTOTYPE — CAMPAIGN LEVEL OPTION D v7 INTERACTIONS
   Zero-gap levers, aligned icon/chevron inside content area.
   ============================================================================ */
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const CAMP_DATA = {
    'GLO Campaign — Core': { strat: 'tCPA £25', role: 'cp', status: 'enabled', budget: '£30/day', cost: '£487', cpa: '£18.50', cpaZone: 'outperforming', cpaDetail: '26% below target', conv: '26', convDetail: 'vs 22 last period (+18%)', qs: '6.2',
      levers: [
        { icon:'devices', name:'Device Modifiers', status:'3 devices · 1 in cooldown', cooldown:'', type:'table', cols:['Device','Modifier','Cost','CPA','Last Changed','Cooldown'], rows:[['Mobile','+10%','£320','£16.50','1 Apr','Ready'],['Desktop','+0%','£142','£21.30','—','Ready'],['Tablet','-35%','£25','£31.25','5 Apr','5d remaining']] },
        { icon:'location_on', name:'Geographic', status:'5 locations · 2 in cooldown', cooldown:'', type:'table', cols:['Location','Modifier','Cost','CPA','Last Changed','Cooldown'], rows:[['England','+0%','£380','£17.80','—','Ready'],['Wales','-10%','£28','£22.40','3 Apr','26d remaining'],['Scotland','-50% (cap)','£12','£36.00','2 Apr','28d remaining'],['N. Ireland','-15%','£18','£24.50','3 Apr','26d remaining'],['London','+10%','£49','£14.20','1 Apr','Ready']] },
        { icon:'schedule', name:'Ad Schedule', status:'3 time slots · 2 in cooldown', cooldown:'', type:'table', cols:['Day/Time','Modifier','Cost','CPA','Last Changed','Cooldown'], rows:[['Sunday all day','-20%','£32','£28.50','5 Apr','25d remaining'],['Saturday all day','-10%','£45','£24.80','5 Apr','25d remaining'],['Mon 2-5pm','+15%','£68','£14.20','—','Ready']] },
        { icon:'block', name:'Negative Keywords', status:'142 across 9 lists', cooldown:'', type:'text', detail:'142 keywords across 9 lists. Last added: 8 Apr. ACT adds [exact] match only. Managed at Keyword Level.' },
        { icon:'sort_by_alpha', name:'Match Types', status:'Broad 15% · Phrase 45% · Exact 40%', cooldown:'', type:'text', detail:'Broad 15%, Phrase 45%, Exact 40%. Changes require approval. Managed at Keyword Level.' },
      ],
      ...
      executed: [
        { text: '<strong>Reduced Sunday schedule modifier</strong>', time: '8 Apr, 05:14 AM', before: '+0%', after: '-20%' },
        { text: '<strong>Reduced tablet device modifier</strong>', time: '8 Apr, 05:15 AM', before: '-20%', after: '-35%' },
        { text: '<strong>Added 4 negative keywords</strong> from search term mining', time: '8 Apr, 05:15 AM' },
      ],
      monitoring: [
  ...
  function openCampSlidein(name) {
    ...
    // BID STRATEGY (collapsed)
    html += `<div class="slidein-section collapsed"><div class="slidein-section__header"><span class="material-symbols-outlined" style="font-size:20px;color:#10b981">target</span><span style="font-size:16px;font-weight:600;color:var(--act-text)">Bid Strategy</span><span class="material-symbols-outlined slidein-section__toggle">expand_more</span></div><div class="slidein-section__body">`;
