...
document.addEventListener('DOMContentLoaded', () => {
  ...
  function mkRows(scale) {
    ...
    const base = [
      { ad: 'Fast Planning Results',          type: 'RSA',       strength: 'good',      camp: 'GLO Campaign — Core',       ag: 'Planning Objections',     status: 'disapproved', impr30: 0,    clicks30: 0,  conv30: 0, days: 42, flags: 1, flagType: 'disapproval' },
      { ad: 'Expert Planning Help',           type: 'RSA',       strength: 'poor',      camp: 'GLO Campaign — Core',       ag: 'Planning Objections',     status: 'enabled',     impr30: 2420, clicks30: 142, conv30: 3, days: 35, flags: 1, flagType: 'ad-strength' },
      { ad: 'Planning Objection Experts',     type: 'RSA',       strength: 'good',      camp: 'GLO Campaign — Core',       ag: 'Planning Objections',     status: 'enabled',     impr30: 3120, clicks30: 214, conv30: 6, days: 72 },
      { ad: 'Planning Objection Letters',     type: 'RSA',       strength: 'average',   camp: 'GLO Campaign — Core',       ag: 'Planning Objection Letters', status: 'enabled',  impr30: 1840, clicks30: 96,  conv30: 2, days: 32, flags: 1, flagType: 'asset-perf' },
      { ad: 'Objection Letter Writing',       type: 'RSA',       strength: 'good',      camp: 'GLO Campaign — Core',       ag: 'Planning Objection Letters', status: 'enabled',  impr30: 1620, clicks30: 82,  conv30: 3, days: 58 },
      { ad: 'Neighbour Planning Objections',  type: 'RSA',       strength: 'good',      camp: 'GLO Campaign — Core',       ag: 'Neighbourhood Objections', status: 'enabled',    impr30: 1340, clicks30: 78,  conv30: 2, days: 45 },
      { ad: 'Stop Neighbour Planning',        type: 'RSA',       strength: 'average',   camp: 'GLO Campaign — Core',       ag: 'Neighbourhood Objections', status: 'enabled',    impr30: 980,  clicks30: 54,  conv30: 1, days: 38 },
      { ad: 'Objection Experts Official',     type: 'RSA',       strength: 'excellent', camp: 'Brand — Objection Experts', ag: 'Main Brand Terms',         status: 'enabled',    impr30: 1820, clicks30: 132, conv30: 2, days: 120 },
      { ad: '600+ Objections Prepared',       type: 'RSA',       strength: 'good',      camp: 'Brand — Objection Experts', ag: 'Main Brand Terms',         status: 'enabled',    impr30: 1240, clicks30: 88,  conv30: 1, days: 90 },
      { ad: 'Call Objection Experts',         type: 'Call Only', strength: 'good',      camp: 'Brand — Objection Experts', ag: 'Main Brand Terms',         status: 'enabled',    impr30: 480,  clicks30: 42,  conv30: 2, days: 60 },
      { ad: 'Consultation Available',         type: 'RSA',       strength: 'good',      camp: 'GLO Campaign — Core',       ag: 'Planning Objections',     status: 'enabled',     impr30: 450,  clicks30: 14,  conv30: 0, days: 25, flags: 1, flagType: 'performance' },
      { ad: 'Free Consultation Offered',      type: 'RSA',       strength: 'good',      camp: 'GLO Campaign — Core',       ag: 'Planning Objections',     status: 'enabled',     impr30: 1120, clicks30: 76,  conv30: 3, days: 42 },
      { ad: 'Book Your Consultation',         type: 'RSA',       strength: 'excellent', camp: 'GLO Campaign — Core',       ag: 'Planning Objections',     status: 'enabled',     impr30: 1540, clicks30: 108, conv30: 4, days: 55 },
      { ad: '5-Day Turnaround Objections',    type: 'RSA',       strength: 'good',      camp: 'GLO Campaign — Core',       ag: 'Long Tail',               status: 'enabled',     impr30: 1280, clicks30: 86,  conv30: 3, days: 48 },
      { ad: 'RTPI Qualified Planner',         type: 'RSA',       strength: 'good',      camp: 'GLO Campaign — Core',       ag: 'Long Tail',               status: 'enabled',     impr30: 1120, clicks30: 74,  conv30: 2, days: 52 },
      { ad: 'From £350+VAT',                  type: 'RSA',       strength: 'average',   camp: 'GLO Campaign — Core',       ag: 'Long Tail',               status: 'enabled',     impr30: 820,  clicks30: 44,  conv30: 1, days: 30 },
      { ad: 'Come Back — Special Offer',      type: 'RSA',       strength: 'good',      camp: 'GLO Campaign — Retargeting', ag: 'Recent Visitors',        status: 'enabled',     impr30: 1620, clicks30: 124, conv30: 5, days: 65 },
      { ad: 'Your Planning Objection',        type: 'RSA',       strength: 'good',      camp: 'GLO Campaign — Retargeting', ag: 'Cart Abandoners',        status: 'enabled',     impr30: 960,  clicks30: 73,  conv30: 5, days: 48 },
      { ad: 'New Brand RSA',                  type: 'RSA',       strength: 'learning',  camp: 'Testing — New Keywords',    ag: 'Test Batch 2',             status: 'enabled',    impr30: 280,  clicks30: 11,  conv30: 1, days: 3 },
      { ad: 'Test Ad Variant A',              type: 'RSA',       strength: 'average',   camp: 'Testing — New Keywords',    ag: 'Test Batch 4',             status: 'enabled',    impr30: 280,  clicks30: 11,  conv30: 0, days: 18 },
    ];
    return base.map(r => {
      const impr = Math.round(r.impr30 * scale);
      const clicks = Math.round(r.clicks30 * scale);
      const conv = Math.round(r.conv30 * scale);
      // Rough cost estimate for display (not authoritative)
      const cost = clicks * 0.64;
      return {
        ...r,
  ...
  function updateTable(range) {
    ...
    totals.innerHTML = `<td></td><td>Total / Average</td><td></td><td></td><td></td><td></td>
      <td>${s.impr}</td><td>${s.clicks}</td><td>${s.ctr}</td>
