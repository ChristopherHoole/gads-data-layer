/* ============================================================================
   ACT PROTOTYPE — CAMPAIGN LEVEL OPTION D v8 INTERACTIONS
   Reasoning, guardrail notes, match bar, full strategy, reordered guardrails.
   ============================================================================ */
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const CAMP_DATA = {
    'GLO Campaign — Core': { strat: 'tCPA £25', role: 'cp', status: 'enabled', budget: '£30/day', cost: '£487', cpa: '£18.50', cpaZone: 'outperforming', cpaDetail: '26% below target', conv: '26', convDetail: 'vs 22 last period (+18%)', qs: '6.2',
      levers: [
        { icon:'devices', name:'Device Modifiers', status:'3 devices · 1 in cooldown', type:'table', cols:['Device','Modifier','Cost','CPA','Last Changed','Cooldown'], rows:[['Mobile','+10%','£320','£16.50','1 Apr','Ready'],['Desktop','+0%','£142','£21.30','—','Ready'],['Tablet','-35%','£25','£31.25','5 Apr','5d remaining']], guardrail:'Caps: -60% / +30% · Cooldown: 7 days' },
        { icon:'location_on', name:'Geographic', status:'5 locations · 2 in cooldown', type:'table', cols:['Location','Modifier','Cost','CPA','Last Changed','Cooldown'], rows:[['England','+0%','£380','£17.80','—','Ready'],['Wales','-10%','£28','£22.40','3 Apr','26d remaining'],['Scotland','-50% (cap)','£12','£36.00','2 Apr','28d remaining'],['N. Ireland','-15%','£18','£24.50','3 Apr','26d remaining'],['London','+10%','£49','£14.20','1 Apr','Ready']], guardrail:'Caps: -50% / +30% · Cooldown: 30 days' },
        { icon:'schedule', name:'Ad Schedule', status:'3 time slots · 2 in cooldown', type:'table', cols:['Day/Time','Modifier','Cost','CPA','Last Changed','Cooldown'], rows:[['Sunday all day','-20%','£32','£28.50','5 Apr','25d remaining'],['Saturday all day','-10%','£45','£24.80','5 Apr','25d remaining'],['Mon 2-5pm','+15%','£68','£14.20','—','Ready']], guardrail:'Caps: -50% / +25% · Cooldown: 30 days' },
        { icon:'block', name:'Negative Keywords', status:'142 across 9 lists', type:'text', detail:'142 keywords across 9 lists. Last added: 8 Apr. ACT adds [exact] match only. Managed at Keyword Level.', guardrail:'ACT adds [exact] match only · Phrase match is human-managed' },
        { icon:'sort_by_alpha', name:'Match Types', status:'Broad 15% · Phrase 45% · Exact 40%', type:'matchbar', guardrail:'Changes require approval · Managed at Keyword Level' },
      ],
      stratTarget: '£25.00', stratAssess: 'Last adjustment: Raised from £23 to £25 on 29 Mar 2026. Next review eligible: 12 Apr 2026 (14-day cooldown).',
      stratHistory: [
        { date: '29 Mar 2026', change: '£23 → £25 (+8.7%)', reason: 'Loosening — CPA above target, approved' },
        { date: '15 Mar 2026', change: '£25 → £23 (-8%)', reason: 'Tightening — CPA 30% below target, auto' },
        { date: '28 Feb 2026', change: '£27 → £25 (-7.4%)', reason: 'Tightening — CPA 25% below target, auto' },
      ],
      approvals: [
        { text: '<strong>Loosen tCPA target</strong> from £25 to £27.50 — CPA 26% below target for 14 days', rec: 'ACT recommends: Increase target to capture more volume', impact: 'Estimated: +2-3 conversions/week', details: {Check:'tCPA loosening review (runs every 7 days)',Signal:'14-day CPA of £18.50 vs £25.00 target = 26% below. Exceeds 15% outperformance threshold.',Rule:'Loosening a tCPA target requires human approval. 10% increase within max single-move cap.',Cooldown:'14-day cooldown begins after approval. Next review: 22 Apr 2026.',Risk:'Low — CPA consistently below target with no upward trend.'} },
        { text: '<strong>Reduce Scotland geo modifier</strong> from +0% to -15% — CPA 45% above target', rec: 'ACT recommends: Apply -15% geo modifier for Scotland', impact: 'Estimated saving: £4/week', details: {Check:'Geo bid adjustment review (runs every 30 days)',Signal:'Scotland CPA 45% above target over 30 days with only 2 conversions.',Rule:'Large geo adjustments (>20%) require approval. -15% is within auto cap.',Cooldown:'30-day cooldown begins after approval.',Risk:'Low — clear underperformance in this region.'} },
        { text: '<strong>Increase Monday schedule bid</strong> from +0% to +15% — Monday CPA £14.20 vs £22.50 avg', rec: 'ACT recommends: Boost Monday bids for best-performing day', impact: 'Estimated: +1 conversion/week', details: {Check:'Ad schedule bid review (runs every 30 days)',Signal:'Monday CPA £14.20 vs £22.50 campaign average. Outperforming by 37%.',Rule:'Positive schedule adjustments are loosening and require approval.',Cooldown:'30-day cooldown begins after approval.',Risk:'Low — Monday is clearly the best-performing day.'} },
      ],
      executed: [
        { text: '<strong>Reduced Sunday schedule modifier</strong>', time: '8 Apr, 05:14 AM', before: '+0%', after: '-20%', reason: 'Sunday CPA £34.50 vs £22.50 campaign average' },
        { text: '<strong>Reduced tablet device modifier</strong>', time: '8 Apr, 05:15 AM', before: '-20%', after: '-35%', reason: 'Tablet CPA 40% above target over 7 days' },
        { text: '<strong>Added 4 negative keywords</strong> from search term mining', time: '8 Apr, 05:15 AM', reason: 'Search terms with spend above target CPA and 0 conversions' },
      ],
      monitoring: [
        { text: '<strong>tCPA cooldown</strong> &mdash; changed &pound;23 &rarr; &pound;25 on 29 Mar', started: '29 Mar 2026, 05:12 AM', progress: 29, remaining: '10 days of 14-day cooldown', health: 'healthy', healthLabel: 'Healthy' },
        { text: '<strong>Tablet device cooldown</strong> &mdash; reduced to -35% today', started: '8 Apr 2026, 05:15 AM', progress: 3, remaining: '5 days of 7-day cooldown', health: 'neutral', healthLabel: 'Too early' },
      ],
      alerts: [
        { text: '<strong>Geo modifier cap reached</strong> &mdash; Scotland at -50% (maximum). Investigate full exclusion.', date: '5 Apr 2026', resolution: 'Acknowledged', resDetail: 'Under review' },
      ]
    },
    'GLO Campaign — Retargeting': { strat: 'tCPA £15', role: 'rt', status: 'enabled', budget: '£10/day', cost: '£164', cpa: '£13.70', cpaZone: 'outperforming', cpaDetail: '9% below target', conv: '12', convDetail: 'vs 10 last period (+20%)', qs: '5.8',
      ...
      approvals:[], executed:[{ text:'<strong>Added 2 negative keywords</strong>', time:'8 Apr, 05:14 AM' }], monitoring:[], alerts:[]
    }
  };
  ...
  function openCampSlidein(name) {
    ...
    // Change 7: Reorder to match main page — Enabled · tCPA · CP · budget
    if (campMeta) campMeta.innerHTML = `<span style="font-size:14px;color:var(--act-text)"><span class="status-dot status-dot--${d.status}"></span> Enabled</span><span class="strategy-badge">${d.strat}</span><span class="role-badge role-badge--${d.role}">${d.role.toUpperCase()}</span><span style="font-size:14px;font-weight:600;color:var(--act-text)">${d.budget}</span>`;
    ...
    // ── Collapsible sections. Approval EXPANDED, others COLLAPSED ──

    // AWAITING APPROVAL (expanded) — with See Details (Change 3)
    if (d.approvals.length > 0) {
      html += `<div class="slidein-section"><div class="slidein-section__header"><span class="material-symbols-outlined" style="font-size:20px;color:var(--act-amber)">pending_actions</span><span style="font-size:16px;font-weight:600;color:var(--act-text)">Awaiting Approval</span><span style="font-size:12px;font-weight:600;padding:2px 8px;border-radius:10px;color:white;background:var(--act-amber)">${d.approvals.length}</span><span class="material-symbols-outlined slidein-section__toggle">expand_more</span></div><div class="slidein-section__body">`;
      d.approvals.forEach((a, idx) => {
        let detailGrid = '';
        if (a.details) {
        ...
        html += `<div class="act-item" data-priority="investigate"><div class="act-item__row"><div class="act-item__content"><div class="act-item__top"><span class="badge-action badge-action--investigate">Investigate</span><span class="badge-risk badge-risk--low">Low Risk</span><span class="act-item__impact"><span class="material-symbols-outlined">trending_up</span>${a.impact}</span></div><div class="act-item__summary">${a.text}</div><div class="act-item__recommendation"><span class="material-symbols-outlined">lightbulb</span>${a.rec}</div>${a.details ? `<div class="slidein-detail-expand" id="slideinDetail${idx}">${detailGrid}</div>` : ''}</div><div class="act-item__actions"><button class="btn-act btn-act--approve" onclick="this.closest('.act-item').style.opacity='0.4';this.closest('.act-item').style.pointerEvents='none';">Approve</button><button class="btn-act btn-act--decline" onclick="this.closest('.act-item').style.opacity='0.4';this.closest('.act-item').style.pointerEvents='none';">Decline</button>${a.details ? `<button class="btn-see-details" data-detail-idx="${idx}">See Details</button>` : ''}</div></div></div>`;
      });
      html += '</div></div>';
    }

    // ACTIONS EXECUTED OVERNIGHT (collapsed) — Change 1: inline pills
    if (d.executed.length > 0) {
      html += `<div class="slidein-section collapsed"><div class="slidein-section__header"><span class="material-symbols-outlined" style="font-size:20px;color:var(--act-green)">check_circle</span><span style="font-size:16px;font-weight:600;color:var(--act-text)">Actions Executed Overnight</span><span style="font-size:12px;font-weight:600;padding:2px 8px;border-radius:10px;color:white;background:var(--act-green)">${d.executed.length}</span><span class="material-symbols-outlined slidein-section__toggle">expand_more</span></div><div class="slidein-section__body">`;
      d.executed.forEach(e => {
        html += `<div class="act-item"><div class="act-item__row"><div class="act-item__content"><div class="act-item__top"><span class="badge-action badge-action--act">Act</span><span class="act-item__timestamp">${e.time}</span></div><div class="act-item__summary">${e.text}${e.before ? ` <span class="act-item__values"><span class="val-pill val-pill--old">${e.before}</span><span class="arrow">&rarr;</span><span class="val-pill val-pill--new-negative">${e.after}</span></span>` : ''}${e.reason ? `<span class="act-item__reason-inline">${e.reason}</span>` : ''}</div></div></div></div>`;
      });
      html += '</div></div>';
    }

    // CURRENTLY MONITORING (collapsed) — Change 5
    if (d.monitoring && d.monitoring.length > 0) {
      html += `<div class="slidein-section collapsed"><div class="slidein-section__header"><span class="material-symbols-outlined" style="font-size:20px;color:var(--act-blue)">visibility</span><span style="font-size:16px;font-weight:600;color:var(--act-text)">Currently Monitoring</span><span style="font-size:12px;font-weight:600;padding:2px 8px;border-radius:10px;color:white;background:var(--act-blue)">${d.monitoring.length}</span><span class="material-symbols-outlined slidein-section__toggle">expand_more</span></div><div class="slidein-section__body">`;
      d.monitoring.forEach(m => {
        const barColor = m.health === 'healthy' ? 'var(--act-green)' : '#9aa0a6';
        const labelClass = m.health === 'healthy' ? 'health-label--healthy' : 'health-label--neutral';
        html += `<div class="act-item"><div class="act-item__row"><div class="act-item__content"><div class="act-item__top"><span class="badge-action badge-action--monitor">Monitor</span><span class="act-item__started"><span class="material-symbols-outlined">calendar_today</span>Started: ${m.started}</span></div><div class="act-item__summary">${m.text}</div><div class="act-item__progress"><div class="act-item__progress-bar"><div class="act-item__progress-fill" style="width:${m.progress}%;background:${barColor}"></div></div><span class="act-item__progress-text">${m.remaining}</span><span class="health-label ${labelClass}">${m.healthLabel}</span></div></div></div></div>`;
      });
      html += '</div></div>';
    }

    // RECENT ALERTS (collapsed) — Change 5
    if (d.alerts && d.alerts.length > 0) {
      html += `<div class="slidein-section collapsed"><div class="slidein-section__header"><span class="material-symbols-outlined" style="font-size:20px;color:var(--act-red)">notifications_active</span><span style="font-size:16px;font-weight:600;color:var(--act-text)">Recent Alerts</span><span style="font-size:12px;font-weight:600;padding:2px 8px;border-radius:10px;color:white;background:var(--act-red)">${d.alerts.length}</span><span class="material-symbols-outlined slidein-section__toggle">expand_more</span></div><div class="slidein-section__body">`;
      d.alerts.forEach(a => {
        html += `<div class="act-item" data-priority="alert"><div class="act-item__row"><div class="act-item__content"><div class="act-item__top"><span class="badge-action badge-action--alert">Alert</span><span class="act-item__timestamp">${a.date}</span></div><div class="act-item__summary">${a.text}</div><div class="act-item__meta"><span class="badge-resolution badge-resolution--approved">${a.resolution}</span><span style="font-size:12px;color:var(--act-text)">${a.resDetail}</span></div></div></div></div>`;
      });
      html += '</div></div>';
    }

    // UNIVERSAL LEVERS (collapsed)
    html += `<div class="slidein-section collapsed"><div class="slidein-section__header"><span class="material-symbols-outlined" style="font-size:20px;color:#10b981">tune</span><span style="font-size:16px;font-weight:600;color:var(--act-text)">Universal Levers</span><span class="material-symbols-outlined slidein-section__toggle">expand_more</span></div><div class="slidein-section__body"><div class="lever-summary">`;
    d.levers.forEach((l, i) => {
      let detailHtml = '';
      if (l.type === 'table') {
        detailHtml = '<table class="lever-mini-table"><thead><tr>' + l.cols.map(c => `<th>${c}</th>`).join('') + '</tr></thead><tbody>' + l.rows.map(r => '<tr>' + r.map(c => `<td>${c}</td>`).join('') + '</tr>').join('') + '</tbody></table>';
      } else if (l.type === 'matchbar') {
        detailHtml = '<div class="slidein-match-bar"><div class="slidein-match-bar__segment" style="width:15%;background:#ef4444">15%</div><div class="slidein-match-bar__segment" style="width:45%;background:#f59e0b">45%</div><div class="slidein-match-bar__segment" style="width:40%;background:#10b981">40%</div></div><div class="slidein-match-legend"><span><span class="slidein-match-legend__dot" style="background:#ef4444"></span>Broad (15%)</span><span><span class="slidein-match-legend__dot" style="background:#f59e0b"></span>Phrase (45%)</span><span><span class="slidein-match-legend__dot" style="background:#10b981"></span>Exact (40%)</span></div>';
      } else {
        detailHtml = `<div style="font-size:14px;color:var(--act-text);padding:8px 0">${l.detail}</div>`;
      }
      if (l.guardrail) detailHtml += `<div class="lever-guardrail-note"><span class="material-symbols-outlined">shield</span><span class="lever-guardrail-note__text">${l.guardrail}</span></div>`;
      html += `<div class="lever-summary-row" data-lever="${i}"><div class="lever-summary-row__header"><span class="material-symbols-outlined">${l.icon}</span><div style="flex:1"><div class="lever-summary__name">${l.name}</div><div class="lever-summary__status">${l.status}</div></div><span class="material-symbols-outlined lever-summary__chevron">chevron_right</span></div><div class="lever-summary__detail">${detailHtml}</div></div>`;
    });
    html += '</div></div></div>';

    // BID STRATEGY (collapsed) — Change 4: Full panel
    html += `<div class="slidein-section collapsed"><div class="slidein-section__header"><span class="material-symbols-outlined" style="font-size:20px;color:#10b981">target</span><span style="font-size:16px;font-weight:600;color:var(--act-text)">Bid Strategy</span><span class="material-symbols-outlined slidein-section__toggle">expand_more</span></div><div class="slidein-section__body" style="padding:16px">`;
    html += `<div style="display:flex;align-items:center;gap:12px;margin-bottom:8px"><div class="slidein-strategy__value">${d.stratTarget}</div><span class="zone-badge zone-badge--${d.cpaZone}">${d.cpaDetail}</span></div>`;
    html += `<div class="slidein-strategy__assess">${d.stratAssess}</div>`;
    if (d.stratHistory && d.stratHistory.length > 0) {
      html += '<table class="lever-mini-table"><thead><tr><th>Date</th><th>Change</th><th>Reason</th></tr></thead><tbody>';
      d.stratHistory.forEach(h => { html += `<tr><td>${h.date}</td><td>${h.change}</td><td>${h.reason}</td></tr>`; });
      html += '</tbody></table>';
    }
    html += '<div style="margin-top:12px"><div style="font-size:12px;font-weight:600;color:var(--act-text);margin-bottom:6px">Supported Strategies</div><div class="slidein-strategy-list"><span class="slidein-strategy-pill">Manual CPC</span><span class="slidein-strategy-pill active">tCPA</span><span class="slidein-strategy-pill">tROAS</span><span class="slidein-strategy-pill">Max Conv</span><span class="slidein-strategy-pill">Max Clicks</span><span class="slidein-strategy-pill">PMax</span><span class="slidein-strategy-pill">Shopping</span></div></div>';
    html += '<div class="lever-guardrail-note" style="margin-top:12px"><span class="material-symbols-outlined">shield</span><span class="lever-guardrail-note__text">Max 10% per cycle · 14-day cooldown · Loosening requires approval</span></div>';
    html += '</div></div>';

    if (campBody) campBody.innerHTML = html;

    // Bind lever row expand — click header only (not table content)
    campBody.querySelectorAll('.lever-summary-row__header').forEach(header => {
      header.addEventListener('click', () => header.closest('.lever-summary-row').classList.toggle('expanded'));
    });

    // Bind collapsible section headers
    campBody.querySelectorAll('.slidein-section__header').forEach(header => {
      header.addEventListener('click', () => header.closest('.slidein-section').classList.toggle('collapsed'));
    });

    // Bind See Details expand (Change 3)
    campBody.querySelectorAll('.btn-see-details').forEach(btn => {
      btn.addEventListener('click', () => {
        const idx = btn.dataset.detailIdx;
        const detail = document.getElementById('slideinDetail' + idx);
        if (detail) {
          detail.classList.toggle('show');
          btn.textContent = detail.classList.contains('show') ? 'Hide Details' : 'See Details';
        }
      });
    });
  ...
  window.closeCampSlidein = function() {
