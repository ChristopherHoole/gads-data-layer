/* ============================================================================
   ACT PROTOTYPE — CAMPAIGN LEVEL OPTION D v6 INTERACTIONS
   Word-for-word monitoring/alerts, count-based lever summaries, See Details below buttons.
   ============================================================================ */
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  function openCampSlidein(name) {
    ...
    d.levers.forEach((l, i) => {
      ...
      html += `<div class="lever-summary-row" data-lever="${i}"><span class="material-symbols-outlined">${l.icon}</span><div style="flex:1"><div class="lever-summary__name">${l.name}</div><div class="lever-summary__status">${l.status}</div><div class="lever-summary__detail">${detailHtml}</div></div><span class="material-symbols-outlined lever-summary__chevron">chevron_right</span></div>`;
    });
    html += '</div></div></div>';
