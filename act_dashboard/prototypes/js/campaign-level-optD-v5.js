/* ============================================================================
   ACT PROTOTYPE — CAMPAIGN LEVEL OPTION D v5 INTERACTIONS
   Inline pills, stacked buttons, See Details, card sections, monitoring + alerts.
   ============================================================================ */
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const CAMP_DATA = {
    'GLO Campaign — Core': { strat: 'tCPA £25', role: 'cp', status: 'enabled', budget: '£30/day', cost: '£487', cpa: '£18.50', cpaZone: 'outperforming', cpaDetail: '26% below target', conv: '26', convDetail: 'vs 22 last period (+18%)', qs: '6.2',
      levers: [
        { icon:'devices', name:'Device Modifiers', status:'Mobile +10%, Desktop +0%, Tablet -35%', cooldown:'Tablet: 5d remaining', type:'table', cols:['Device','Modifier','Cost','CPA','Last Changed','Cooldown'], rows:[['Mobile','+10%','£320','£16.50','1 Apr','Ready'],['Desktop','+0%','£142','£21.30','—','Ready'],['Tablet','-35%','£25','£31.25','5 Apr','5d remaining']] },
        { icon:'location_on', name:'Geographic', status:'5 locations, Scotland -50% (cap)', cooldown:'All ready', type:'table', cols:['Location','Modifier','Cost','CPA','Last Changed','Cooldown'], rows:[['England','+0%','£380','£17.80','—','Ready'],['Wales','-10%','£28','£22.40','3 Apr','26d remaining'],['Scotland','-50% (cap)','£12','£36.00','2 Apr','28d remaining'],['N. Ireland','-15%','£18','£24.50','3 Apr','26d remaining'],['London','+10%','£49','£14.20','1 Apr','Ready']] },
        { icon:'schedule', name:'Ad Schedule', status:'Sunday -20%, Saturday -10%', cooldown:'Sunday: 25d remaining', type:'table', cols:['Day/Time','Modifier','Cost','CPA','Last Changed','Cooldown'], rows:[['Sunday all day','-20%','£32','£28.50','5 Apr','25d remaining'],['Saturday all day','-10%','£45','£24.80','5 Apr','25d remaining'],['Mon 2-5pm','+15%','£68','£14.20','—','Ready']] },
        { icon:'block', name:'Negative Keywords', status:'142 across 9 lists', cooldown:'Last added: 8 Apr', type:'text', detail:'142 keywords across 9 lists. Last added: 8 Apr. ACT adds [exact] match only. Managed at Keyword Level.' },
        { icon:'sort_by_alpha', name:'Match Types', status:'Broad 15%, Phrase 45%, Exact 40%', cooldown:'Changes require approval', type:'text', detail:'Broad 15%, Phrase 45%, Exact 40%. Changes require approval. Managed at Keyword Level.' },
      ],
      ...
      monitoring: [
        { text: '<strong>tCPA adjustment cooldown</strong> — changed from £23 to £25', started: '29 Mar 2026, 05:12 AM', progress: 29, remaining: '10 days remaining of 14-day cooldown', health: 'healthy', healthLabel: 'Healthy' },
        { text: '<strong>Device bid cooldown (tablet)</strong> — reduced to -35%', started: '8 Apr 2026, 05:15 AM', progress: 3, remaining: '5 days remaining of 7-day cooldown', health: 'neutral', healthLabel: 'Too early' },
      ],
      alerts: [
        { text: '<strong>Geo modifier cap reached</strong> — Scotland at -50% (maximum cap). Investigate if location should be excluded entirely.', date: '3 Apr 2026', resolution: 'Acknowledged', resDetail: 'Under review' },
      ]
    },
  ...
  function openCampSlidein(name) {
    ...
    d.levers.forEach((l, i) => {
      ...
      html += `<div class="lever-summary-row" data-lever="${i}"><span class="material-symbols-outlined">${l.icon}</span><div style="flex:1"><div class="lever-summary__name">${l.name}</div><div class="lever-summary__status">${l.status}</div><div class="lever-summary__cooldown">${l.cooldown}</div><div class="lever-summary__detail">${detailHtml}</div></div><span class="material-symbols-outlined lever-summary__chevron">chevron_right</span></div>`;
    });
    html += '</div></div></div>';
