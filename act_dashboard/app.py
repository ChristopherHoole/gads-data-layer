...
def create_app():
    ...
    # Chat 65: CSRF exemption for sync-from-sheets (JSON API, no CSRF tokens sent)
    # POST /outreach/sync-from-sheets is a JSON API called from JavaScript
    # Protected by @login_required decorator instead
    ...
    # Chat 75: CSRF exemption for queue-email + edit-lead (JSON APIs, no CSRF tokens sent)
    # POST /outreach/leads/<id>/queue-email and PUT /outreach/leads/<id>/edit
    # Protected by @login_required decorator instead
    chat75_routes = [
        'outreach.queue_email',
        'outreach.edit_lead',
    ]
    ...
    # Chat 93: CSRF exemption for save-as-template endpoint (JSON API, no CSRF tokens sent)
    # POST /campaigns/rules/<id>/save-as-template is a JSON API called from JavaScript
    # Protected by @login_required decorator instead
    ...
    # [Chat 107] Ad Group Rules & Flags routes — CSRF exemptions
    chat107_routes = [
        'ad_groups.ag_list_rules',
        'ad_groups.ag_create_rule',
        'ad_groups.ag_update_rule',
        'ad_groups.ag_delete_rule',
        'ad_groups.ag_toggle_rule',
        'ad_groups.ag_save_as_template',
    ]
    ...
    chat111_routes = [
        ...
        'shopping.shopping_campaign_create_rule',
        'shopping.shopping_campaign_update_rule',
        'shopping.shopping_campaign_delete_rule',
        'shopping.shopping_campaign_toggle_rule',
        'shopping.shopping_campaign_save_as_template',
    ]
    ...
    chat108_routes = [
        ...
        'keywords.kw_create_rule',
        'keywords.kw_update_rule',
        'keywords.kw_delete_rule',
        'keywords.kw_toggle_rule',
        'keywords.kw_save_as_template',
    ]
    ...
    # Session B2: ACT v2 Shared API — recommendation actions
    v2_api_routes = [
    ...
    for route_name in v2_api_routes:
        if route_name in app.view_functions:
            csrf.exempt(app.view_functions[route_name])
            print(f"[OK] [B2] CSRF exempted: {route_name}")
        else:
