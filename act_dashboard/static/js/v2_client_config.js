...
document.addEventListener('DOMContentLoaded', () => {
  ...
  document.querySelectorAll('.config-tab').forEach(tab => {
    tab.addEventListener('click', () => {
      ...
      // IA refactor (13 May 2026): the Negative Lists tab moved to the
      // Search Terms page. No lazy-load hook needed here any more.
    });
  });
  ...
  // IA refactor (13 May 2026): Negative Lists viewer moved to
  // static/js/v2_negative_lists.js, hosted on the Search Terms page.
});
