...
SETTINGS = [
    ...
    ('tcpa_adjustment_cooldown_days', '14', 'int', 'campaign'),
    ('troas_adjustment_cooldown_days', '14', 'int', 'campaign'),
    ...
    ('max_single_tcpa_move_pct', '10', 'int', 'campaign'),
    ('max_single_troas_move_pct', '10', 'int', 'campaign'),
