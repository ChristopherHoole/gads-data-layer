...
def run_daily_workflow(config_path: str, snapshot_date: date):
    ...
    lighthouse_cmd = [
        sys.executable, "-m", "act_lighthouse.cli", "run-v0",
        config_path,
    ...
    try:
        ...
        print(f"  Lighthouse: reports/lighthouse/{report['client_name']}/{snapshot_date}.json")
...
def main():
    ...
    if len(sys.argv) < 3:
        ...
        print("Example: python tools/daily_workflow.py configs/client_synthetic.yaml 2026-02-11")
        sys.exit(1)
