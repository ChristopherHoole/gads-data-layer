...
CAMPAIGNS = [
    ...
    {
        "id": "3011",
        "name": "Seasonal High Amplitude",
        "scenario": "seasonal",
        "amplitude": 0.5,
    },
    {
        "id": "3012",
        "name": "Seasonal Low Amplitude",
        "scenario": "seasonal",
        "amplitude": 0.25,
    },
    ...
    {
        "id": "3018",
        "name": "Budget Constrained High",
        "scenario": "budget_constrained",
        "lost_is": 0.25,
    },
    {
        "id": "3019",
        "name": "Budget Constrained Medium",
        "scenario": "budget_constrained",
        "lost_is": 0.18,
    },
...
def generate_campaign_day(campaign, current_date, day_index):
    ...
    impressions, clicks, cost, conversions, conv_value = generator(
        campaign, day_index, base_metrics
    )
...
def write_to_duckdb(rows):
    ...
    row_count = conn.execute(
        "SELECT COUNT(*) FROM analytics.campaign_daily WHERE customer_id = '9999999999'"
    ).fetchone()[0]
