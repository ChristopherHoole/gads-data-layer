...
def test_invalid_campaign():
    ...
    assert 'invalid campaign_id' in result['error'].lower(), "Should mention invalid campaign_id"
...
def test_negative_budget():
    ...
    assert 'must be positive' in result['error'].lower(), "Should mention positive requirement"
...
def test_invalid_customer_id():
    ...
    assert 'invalid customer_id' in result['error'].lower(), "Should mention invalid customer_id"
...
def test_short_customer_id():
    ...
    assert '10 digits' in result['error'].lower(), "Should mention 10 digits requirement"
