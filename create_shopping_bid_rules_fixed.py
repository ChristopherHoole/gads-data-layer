...
for rule in rules:
    # Insert rule with correct schema
    result = conn.execute("""
        INSERT INTO rules (
            client_config, entity_type, name, rule_or_flag, type,
...
print(f"(Flags are counted separately with rule_or_flag='flag')")

conn.close()

print("\n✅ DONE - Restart Flask and check Shopping > Rules tab")
print("Should now show 14 rules in the Rules section")
