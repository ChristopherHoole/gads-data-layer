"""
Dental by Design - Report 2: Account Structure & Issues (v5)
v5: Hardcoded verified landing page CPA data into chart generation.
No dynamic loading for slide 9 chart — numbers locked in.
"""
...
# SAVE
# ══════════════════════════════════════════════════════════════════
output=os.path.join(REPORTS,'02_account_structure_report_v5.pptx')
prs.save(output)
print(f"\nSaved to: {output}")
