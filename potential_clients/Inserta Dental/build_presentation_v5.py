"""
Christopher Hoole — Dental by Design Interview Presentation v5
v5 changes: title case (no all-caps), soften competitive line on slide 6,
cropped ACT screenshot for legibility on Teams screen share.
"""
import os
...
ACT_LOGO = os.path.join(SCRIPT_DIR, 'act_logo_official.png')
ACT_SCREENSHOT = os.path.join(PROJECT_ROOT, 'act_dashboard', 'prototypes', 'screenshots', 'v6-light-cropped.png')
...
txt(sl, Inches(0.85), Inches(5.50), Inches(11.63), Inches(0.60),
...
# ── Save ──
out = os.path.join(SCRIPT_DIR, 'Christopher_Hoole_Dental_by_Design_Presentation_v5.pptx')
prs.save(out)
