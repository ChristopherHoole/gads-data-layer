"""
Dental by Design - Report 2: Account Structure & Issues (v4)
v4: Fixed c25 variable overwrite bug. All landing page and ad strength data
verified against raw files. Homepage shows in chart.
"""
...
# SAVE
# ══════════════════════════════════════════════════════════════════
output=os.path.join(REPORTS,'02_account_structure_report_v4.pptx')
prs.save(output)
print(f"\nSaved to: {output}")
