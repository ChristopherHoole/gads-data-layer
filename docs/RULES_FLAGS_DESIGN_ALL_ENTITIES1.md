...
- Condition: cpa_w14_mean < target_cpa * 0.7 AND conversions_w14_sum ≥ 10 AND target_cpa IS NOT NULL
...
- Severity: MEDIUM
- Cooldown: 14 days
- Note: Requires search_impression_share in ad_daily (verify availability)
...
- Severity: HIGH
- Cooldown: 1 day
- Note: Requires ad_status column in ad_daily (verify availability - may need to skip if not available)
...
- Action: Increase campaign default max CPC by 15%
- Cooldown: 14 days
- Note: For manual bidding campaigns only

**SH-BID-002: Decrease Bid - Weak ROAS**
- Condition: roas_w14_mean < 2.0 AND conversions_w14_sum ≥ 5
- Action: Decrease campaign default max CPC by 15%
- Cooldown: 14 days
- Note: For manual bidding campaigns only

**SH-BID-003: Increase Bid - Low Impression Share**
- Condition: search_impression_share < 40%
- Action: Increase campaign default max CPC by 20%
- Cooldown: 14 days
- Note: For manual bidding campaigns only

**SH-BID-004: Decrease Bid - High CPA**
- Condition: cpa_w14_mean > 60000000 AND conversions_w14_sum ≥ 5
- Action: Decrease campaign default max CPC by 20%
- Cooldown: 14 days
- Note: For manual bidding campaigns only
...
- Action: Increase campaign default max CPC by 10%
- Cooldown: 7 days
- Note: For manual bidding campaigns only
