# CHAT 56: DASHBOARD DESIGN UPGRADE - MODULE 4 TABLE REDESIGN

**Estimated Time:** 8-10 hours  
**Dependencies:** Module 1-3 complete (left nav, metrics cards, charts), Wireframe approved  
**Priority:** HIGH
...
**Christopher will ONLY upload this brief (CHAT_56_BRIEF.md). Everything else is in `/mnt/project/`.**
...
I confirm:
1. Christopher will ONLY upload the brief (CHAT_56_BRIEF.md)
...
The current tables across all 6 dashboard pages use basic Bootstrap styling with minimal interactivity. Users cannot adjust column visibility, pagination is limited, and the visual design doesn't match the Google Ads aesthetic established in Modules 1-3.

### Why This Task Is Needed

Module 4 is the final phase of Dashboard Design Upgrade Phase 1. The wireframe has been finalized with Christopher's approval after 8 iterations, incorporating density optimizations (10px padding, dynamic column widths, "Conv" abbreviation). The CSS has been extracted to a separate file for maintainability. All interactive features (column selector, pagination, filters) have been tested and approved in the wireframe.
...
Implement the approved Google Ads-style table design with interactive features (column selector, pagination, filters) across all 6 dashboard pages using the finalized wireframe and extracted CSS.
...
3. keywords.html: C:\Users\User\Desktop\gads-data-layer\act_dashboard\templates\keywords.html (modify)
   - Purpose: Keyword-specific table with entity-specific columns
   - Key features: Same interactive features as campaigns, keyword data only

4. ad_groups.html: C:\Users\User\Desktop\gads-data-layer\act_dashboard\templates\ad_groups.html (modify)
   - Purpose: Ad group-specific table with entity-specific columns
   - Key features: Same interactive features as campaigns, ad group data only

5. ads.html: C:\Users\User\Desktop\gads-data-layer\act_dashboard\templates\ads.html (modify)
   - Purpose: Ad-specific table with entity-specific columns
   - Key features: Same interactive features as campaigns, ad data only

6. shopping.html: C:\Users\User\Desktop\gads-data-layer\act_dashboard\templates\shopping.html (modify)
   - Purpose: Shopping-specific table with entity-specific columns
   - Key features: Same interactive features as campaigns, shopping data only

7. dashboard.html: C:\Users\User\Desktop\gads-data-layer\act_dashboard\templates\dashboard.html (modify)
   - Purpose: Aggregated summary table (scope TBD in 5 questions)
   - Key features: Same interactive features, summary data

8. CHAT_56_SUMMARY.md: C:\Users\User\Desktop\gads-data-layer\docs\CHAT_56_SUMMARY.md (create)
   - Purpose: Executive summary for quick reference
   - Key sections: Overview, deliverables, testing summary, 8+ screenshots, time tracking

9. CHAT_56_HANDOFF.md: C:\Users\User\Desktop\gads-data-layer\docs\CHAT_56_HANDOFF.md (create)
...
### Column Structure (Campaigns Page Example)
...
**Note:** Other pages will have entity-specific columns (Keywords: Match type, Ads: Ad type, etc.)
...
- act_dashboard/templates/campaigns.html - Current table structure
- act_dashboard/templates/keywords.html - Current table structure
- act_dashboard/static/css/ - Existing CSS patterns

**Wireframe and CSS:**
- Wireframe: MODULE_4_WIREFRAME_CAMPAIGNS_v8_DENSITY.html (will be provided)
- CSS: table-styles.css (will be provided)
...
- [ ] 1. table-styles.css created with all required styling (520 lines from wireframe)
- [ ] 2. campaigns.html updated with new table structure
- [ ] 3. keywords.html updated with entity-specific columns
- [ ] 4. ad_groups.html updated with entity-specific columns
- [ ] 5. ads.html updated with entity-specific columns
- [ ] 6. shopping.html updated with entity-specific columns
- [ ] 7. dashboard.html updated with summary table
...
- [ ] 20. All 8+ screenshots provided showing each page working
- [ ] 21. CHAT_56_SUMMARY.md completed (400-700 lines)
- [ ] 22. CHAT_56_HANDOFF.md completed (800-1,500 lines)
...
**IMPORTANT:** Test AT EVERY STEP. Do not proceed to next page until current page is 100% working.
...
1. **CHAT_56_SUMMARY.md** (400-700 lines)
   - Executive overview
...
2. **CHAT_56_HANDOFF.md** (800-1,500 lines)
...
**Git:**
- Prepare commit message (format provided in brief)
...
- dashboard.html implementation: 1 hour
