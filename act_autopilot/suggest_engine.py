...
class SuggestEngine:
    ...
    def save_report(
        self,
        report: Dict[str, Any],
        output_dir: str = "reports/suggestions"
    ) -> Path:
...
def main():
    ...
    if len(sys.argv) < 3:
        print("Usage: python -m act_autopilot.suggest_engine <config_path> <snapshot_date>")
        print("Example: python -m act_autopilot.suggest_engine configs/client_synthetic.yaml 2026-02-11")
        sys.exit(1)
